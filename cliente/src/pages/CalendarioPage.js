...
export const CalendarioPage = () => {
  ...
  return (
    <div className="calendario">
      <div className="section-title calendario-title">CALENDARIO DE <span style={{ color: '#7ac678' }}> EVENTOS🎯</span>
      <Group className='grupo_btn_calendar' position="center">
        <Button className='btn_modals' onClick={OpenEventosCalendar}>Ver Eventos</Button>
        <Button className='btn_modals' onClick={OpenAddEventos}>Crear Eventos</Button>
      </Group>
      </div>
