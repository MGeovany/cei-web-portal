...
import { TextInput, Button, Group, Box, RadioGroup, Radio, NativeSelect, MultiSelect } from '@mantine/core';
import { useForm } from '@mantine/form';

const data = [
    { value: 'mentorias', label: 'Mentoria para el desarrollo de la idea de negocio.' },
    { value: 'formacion', label: 'Formacion/asesoramiento en temas de emprendimiento' },
    ...
    { value: 'conexiones', label: 'Conectar con otros programas del ecosistema emprendedor' },
   ...
   <Box  sx={{ maxWidth: 800 }} mx="auto">
     <form className='form_postulate' onSubmit={form.onSubmit((values) => console.log(values))}>
        ...
        <TextInput
          ...
          size='md'
          {...form.getInputProps('cuenta_postulante')}
        />
        <TextInput
          required
          className='text'
        ...
        required
        size='md'>
        <Radio value="comercial" label="Comercial (Compra y comercializacion de productos o servicios.)"/>
        <Radio value="social" label="Social (Fundaciones, ONG's, empresas con mision social)"/>
        <Radio value="emprendimiento" label="Emprendimiento tecnologico"/>
        <Radio value="healt_care" label="Healt Care (Salud)"/>
        <Radio value="artesanal" label="Artesanal (Productos elaborados comestibles y no comestibles)"/>
        </RadioGroup>
        ...
        <TextInput
          ...
          size='md'
          {...form.getInputProps('describ_emprendimiento')}
        />
        <MultiSelect
        className='text'
        size='md'
