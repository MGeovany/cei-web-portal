    ...
    <div>
      <div className='footer flex'>
        <div className='footer-title'>
          <span style={{ color: '#4A79CB' }}>CEI</span> de CEUTEC
        </div>
        ...
        <div className='footer-links'>
          <a  href='https://www.facebook.com/CEI.CEUTEC/' target='_blank' rel='noreferrer'>
          <Facebook width={24} height={24} fill={'#ffff'} />
          </a>
          <a  href='https://www.instagram.com/vida_estudiantil_ceutec/' target='_blank' rel='noreferrer'>
          <Instagram width={24} height={24} className="cursor-pointer" fill={'#ffff'}/>
          </a>
          <a  href='https://www.linkedin.com/school/ceutec/' target='_blank' rel='noreferrer'>
